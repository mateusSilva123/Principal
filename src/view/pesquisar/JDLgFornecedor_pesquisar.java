 ...
 * @author u13766540670
 */
public class JDLgFornecedor_pesquisar extends javax.swing.JDialog {
     ...
     */
    public JDLgFornecedor_pesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         fornecedorControle = new  FornecedorControle();
        FornecedorDAO admDAO = new FornecedorDAO();
    ...
    private void jBtnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConfirmarActionPerformed
      ...
      Fornecedor fornecedor =fornecedorControle.getbean(rowsel);
       jDlgFornecedor.beanviaw(fornecedor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDLgFornecedor_pesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDLgFornecedor_pesquisar dialog = new JDLgFornecedor_pesquisar(new javax.swing.JFrame(), true);
